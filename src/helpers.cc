...
std::vector<fastjet::PseudoJet> MOD::filter_charged(std::vector<fastjet::PseudoJet> particles) {
  ...
  vector<int> pdg_ids { -11, -12, -13, -14, -16, -211, -2112, -2212, -321, 11, 12, 13, 130, 14, 16, 211, 2112, 22, 2212, 321, 32122, 310, 3222, 3122, 3312, 3322, -310, -3222, -3122, -3312, -3322, 3112, -3112, 3334, -3334};

  vector<int> charged_pdg_ids {11, 13, 15, 211, 321, 2212, 3222, 3312, 3334};
